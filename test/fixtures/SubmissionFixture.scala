...
trait SubmissionFixture {
  ...
  def errorJson(emailFirstPart: String) = {
  ...
  |         "contactDetails":{
  |            "phoneNumber":"000000000000",
  |            "emailAddress":"$emailFirstPart@test.com"
  |         },
  |         "contactAddress":{
  |            "addressLine1":"line 1",
  |            "addressLine2":"Line 2",
  ...
  def getErrorJson(emailFirstPart:String):JsValue = {
    Json.parse(errorJson(emailFirstPart).toString)
  }
